...
def creacionIndividuos():
    for i in range(pob):
        individuos.append([random.randint(0,10),random.randint(0,10),random.randint(0,10),random.randint(0,10)])

def calculoAptitudes():
    sumaApt = 0
    T = 0
...
def mutacion(tasa_mutacion = 0.01):
